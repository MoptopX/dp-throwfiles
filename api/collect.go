...
import (
	...
	"github.com/MoptopX/dp-throwfiles/aggregator"
	"github.com/MoptopX/dp-throwfiles/datastore"
	"github.com/MoptopX/dp-throwfiles/models"
)
...
func NewCollector(store datastore.Datastore) *Collector {
	bufferCap := 100                         // persist every 100 pageviews, see
...
func (c *Collector) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	// indicate that we're not tracking user data, see 
	w.Header().Set("Tk", "N")
...
func shouldCollect(r *http.Request) bool {
	...
	// don't track prerendered pages, see 
